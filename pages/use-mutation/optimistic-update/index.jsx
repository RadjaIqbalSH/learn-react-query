...
const OptimisticUpdateMutation = () => {
  ...
  const mutation = useMutation({
    ...
    onMutate: async (newData) => {
      ...
      await queryClient.setQueryData(['PRODUCTS', page],(old) => {
        prevData = old
        return ({
          ...old,
    ...
    onError: async (err, newData, context) => {
      await queryClient.setQueryData(['PRODUCTS', page], context.prevData)
    },
    onSettled: async() => {
...
export default OptimisticUpdateMutation
